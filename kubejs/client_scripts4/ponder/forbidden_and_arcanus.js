    Ponder.registry(nadien => {
        nadien.create(["forbidden_arcanus:hephaestus_forge", "forbidden_arcanus:darkstone_pedestal", "forbidden_arcanus:arcane_crystal_obelisk"])
            .scene("heph_forge", "Construccion De La Forja", "kubejs:hephforge", (scene, util) => {
                for (let x = 0; x < 9; x++) {
                    for (let z = 0; z < 9; z++) {
            ...
            .scene("heph_forge2", "Usando De La Forja De Hephaestus", "kubejs:hephforge", (scene, util) => {
