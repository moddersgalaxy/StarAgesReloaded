//Script by GhostyRex
Ponder.tags((nadien) => {
	nadien.createTag("kubejs:thermal", "thermal:machine_furnace", "Electric Machines", "Electric Machines", [
...
Ponder.registry((nadien) => {
	nadien.create(["#thermal:machines"]).scene("thermal_tech", "Electric Machines", "kubejs:thermalponder1", (scene, util) => {
		scene.showBasePlate()
		scene.idle(20)
	...
	nadien.create(["thermal:device_tree_extractor"]).scene("thermal_extrr", "Extractor", "kubejs:thermalponder2", (scene, util) => {
		scene.showStructure()
		scene.idle(20)
