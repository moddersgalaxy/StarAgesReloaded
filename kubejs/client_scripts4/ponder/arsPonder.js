//Script by GhostyRex
Ponder.tags((nadien) => {
	nadien.createTag("kubejs:ars_nouveau", "ars_nouveau:enchanting_apparatus", "Ars Magic", "Ars Nouveau Recipes", [
        "ars_nouveau:enchanting_apparatus"
    ]);
})

Ponder.registry((nadien) => {
	nadien.create(["ars_nouveau:enchanting_apparatus","ars_nouveau:imbuement_chamber","ars_nouveau:arcane_core","ars_nouveau:arcane_pedestal"]).scene("ars_recipe", "Ars Nouveau Recipes", "kubejs:arsponder1", (scene, util) => {
		scene.showStructure()
		scene.idle(20)
