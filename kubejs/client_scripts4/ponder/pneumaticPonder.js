...
Ponder.tags((nadien) => {
         ...
         * [...items]               -> default items
         */
          nadien.createTag("pneumaticponder1", 'pneumaticcraft:pressure_chamber_wall', "Camara De presion.", "!By SrNadien¡", "kubejs:pneumaticponder1", [
            // some default items
             'pneumaticcraft:pressure_chamber_wall','pneumaticcraft:pressure_chamber_interface','pneumaticcraft:pressure_chamber_valve', 'pneumaticcraft:pressure_chamber_glass', 
        ]);
});

Ponder.registry((nadien) => {
    nadien.create(["pneumaticcraft:pressure_chamber_wall","pneumaticcraft:pressure_chamber_interface","pneumaticcraft:pressure_chamber_valve", "pneumaticcraft:pressure_chamber_glass"]).scene("pneumaticponder1", "Creating a Pressure Chamber", "kubejs:pneumaticponder1", "kubejs:pneumaticponder1", (scene, util) => {
		scene.showBasePlate()
    scene.idle(10)
    for (let x = 1; x < 4; x++) {
        for (let z = 1; z < 4; z++) {
  ...
  nadien.create(["pneumaticcraft:pressure_tube","pneumaticcraft:reinforced_pressure_tube","pneumaticcraft:advanced_pressure_tube"]).scene("pressure_tubes", "Pressure in Tubes", "kubejs:pneumaticponder3", (scene, util) => {
    scene.showBasePlate()
    scene.idle(20)
    for (let z = 1; z < 6; z++) {
    ...
    nadien.create(["pneumaticcraft:safety_tube_module","pneumaticcraft:pressure_gauge_module","pneumaticcraft:flow_detector_module","pneumaticcraft:air_grate_module","pneumaticcraft:regulator_tube_module","pneumaticcraft:charging_module","pneumaticcraft:logistics_module","pneumaticcraft:redstone_module","pneumaticcraft:vacuum_module"]).scene("tube_modules", "Applying Modules to Tubes", "kubejs:pneumaticponder4", (scene, util) => {
      scene.showBasePlate()
      scene.idle(20)
      for (let z = 1; z < 4; z++) {
        scene.world.showSection([5, 1, z], Facing.DOWN);
    ...
    nadien.create(["pneumaticcraft:assembly_controller","pneumaticcraft:assembly_laser","pneumaticcraft:assembly_platform","pneumaticcraft:assembly_io_unit_export","pneumaticcraft:assembly_io_unit_import","pneumaticcraft:assembly_drill"]).scene("assembly_line", "Assembly in Pneumatics", "kubejs:pneumaticponder5", (scene, util) => {
      scene.showStructure()
      scene.idle(20)
